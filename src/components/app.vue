...
<f7-app :params="f7params" theme-dark>
  ...
  <f7-views tabs class="safe-areas">
    ...
    <f7-toolbar tabbar labels bottom>
      ...
      <f7-link tab-link="#view-countries" icon-ios="f7:square_list_fill" icon-aurora="f7:square_list_fill" icon-md="material:view_list" text="Countries"></f7-link>
    ...
    <!-- Catalog View -->
    <f7-view id="view-countries" name="countries" tab url="/countries/"></f7-view>
  ...
  export default {
    data() {
      return {
        ...
        f7params: {
          id: 'com.nash0.coronatime', // App bundle ID
          name: 'Corona Time', // App name
